...
Route::get('qrcode', function () {
    $code = QrCode::size(300)->generate('https://joodya.com/joodyasell');
    return $code;
});
Route::post('/send_order','mobileController@send_order')->name('send_order');
Route::post('restaurants/search','mobileController@restaurantsSearch');

Route::group(['prefix' => 'mobile'], function () {
//    Route::post('/send_order','mobileController@send_order')->name('send_order');

    Route::get('restaurants','mobileController@restaurantsShow');
    Route::get('restaurantMenue/{id}','mobileController@restaurantMenue');
    Route::get('offers','mobileController@offers');
    Route::get('cartDetails','mobileController@cartDetails');
    Route::post('orderDetails', 'mobileController@confirm_order_details');
    Route::get('restaurantNewOrders', 'mobileController@restaurantNewOrders');
    Route::get('orderArchive', 'mobileController@orderArchive');
    Route::get('holdOrder/{id}', 'mobileController@holdOrder');
    Route::get('endOrder/{id}', 'mobileController@endOrder');
    Route::get('cancelOrder/{id}', 'mobileController@cancelOrder');
    Route::get('soryOrder/{id}', 'mobileController@soryOrder');
    Route::get('myRestaurant','mobileController@myRestaurant');
    Route::get('delete_from_cart/{id}','mobileController@delete_from_cart')->name('delete_from_cart');

    Route::get('add_to_cart/{id}/{restaurant}/{quantity}','mobileController@add_to_cart')->name('add_to_cart');
    Route::get('like_item/{id}','mobileController@like_item')->name('like_item');
    Route::get('h_price/{id}','mobileController@h_price')->name('h_price');
    Route::get('not_clear/{id}','mobileController@not_clear')->name('not_clear');



});
Route::get('ajax','ajaxController@index');
Route::post('ajax','ajaxController@addMenu')->name('addMenu');
Route::post('editMenu','ajaxController@editMenu')->name('editMenu');
Route::get('deleteItem/{id}','ajaxController@deleteItem')->name('deleteItem');

Route::group(['prefix' => 'joodyasell'], function () {

    Route::get('register','joodyasellController@register');
    Route::get('createRestaurant','joodyasellController@createRestaurant');
    Route::get('restaurantPage','joodyasellController@restaurantPage');
    Route::get('orderArchive','joodyasellController@orderArchive');
    Route::post('login', 'joodyasellController@postLogin');
    Route::get('logout', 'joodyasellController@logout');
    Route::post('register_user', 'joodyasellController@register_user');
    Route::post('addRestaurant', 'joodyasellController@addRestaurant');
    Route::post('addToMenu', 'joodyasellController@addToMenu')->name('addToMenu');
    Route::post('saveRestaurantChange', 'joodyasellController@saveRestaurantChange')->name('saveRestaurantChange');
    Route::post('sendPassword', 'joodyasellController@sendPassword')->name('sendPassword');
    Route::get('restaurantProfile','joodyasellController@restaurantProfile');
    Route::get('endOrder/{id}','joodyasellController@endOrder');
    Route::get('apol_order/{id}','joodyasellController@apol_order');
    Route::get('cancel_order/{id}','joodyasellController@cancel_order');
    Route::get('hold_order/{id}','joodyasellController@hold_order');
    Route::get('delete_order/{id}','joodyasellController@delete_order');
...
Route::group(['namespace' => 'Admin', 'prefix' => 'admin'], function () {
    Route::get('orderlist/cheack', 'OrderController@owner_orderlist_cheack_new');
    ...
    Route::get('restaurants/view/orderlist/{order_id}/{status}', 'OrderController@order_status');
    Route::get('restaurants/view/orderlist/{order_id}', 'OrderController@delete');
//restaurants/view/11/orderlist/31/الإنتظار
    ...
    Route::get('categories/addcategory/{cat_id}', 'CategoriesController@editOwnerCategory');
    ...
    Route::get('order/view/{order_id}', 'OrderController@orderView');
    ...
    Route::get('orderlist/view/{order_id}', 'OrderController@owner_order');
    Route::get('order/view/{order_id}', 'OrderController@orderView');
    ...
    Route::get('owners', 'UsersController@ownerslist');
    Route::get('drivers', 'UsersController@driverslist');
    Route::get('suppliers', 'UsersController@supplierslist');
...
Route::get('appDownload', 'IndexController@appDownload');
Route::get('getArea', 'RestaurantsController@getArea');
Route::get('getType', 'RestaurantsController@getType');

Route::get('moremenu','RestaurantsController@moremenu');
Route::get('mobile','IndexController@showMobile');
Route::get('joodyasell','IndexController@joodyasell');
Route::get('mobile/restaurants/{id}','IndexController@mobileRestaurants');
...
Route::get('add_item/{item_id}/{quantity}', 'CartController@add_cart_item');

Route::get('delete_item/{item_id}', 'CartController@delete_cart_item');

Route::post('add_item_with_features', 'CartController@add_cart_item_with_features');
