...
class UsersController extends MainAdminController
{
    ...
    public function userslist()    { 
        ...
        $allusers = User::where('usertype', '=', 'User')->orderBy('id')->get();
    ...
    public function ownerslist()    {
        ...
        $allusers = User::where('usertype', '=', 'Owner')->orderBy('id')->get();
    ...
    public function driverslist()    {
        ...
        $allusers = User::where('usertype', '=', 'Driver')->orderBy('id')->get();
    ...
    public function supplierslist()    {
        ...
        $allusers = User::where('usertype', '=', 'Supplier')->orderBy('id')->get();
    ...
    { 
		...
		if(!empty($inputs['id'])){
            ...
            \Session::flash('flash_message', 'تمت اضافة المستخدم بنجاح');
