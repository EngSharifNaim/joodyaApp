...
$('.addtocart').on('click',function(event){
	...
	console.log(jsonitem.menu_name) ; 
	...
	*/
	...
	$(".modal-meal-name").text(jsonitem.menu_name) ; 

		if (jsonitem.menu_image.length > 1 ){
			var menu_image =  'upload/menu/'+jsonitem.menu_image+'-s.jpg';
		}else {
			
			var menu_image =  'upload/menu_img_s.png' ;

		}


	$(".modal-meal-image").attr("src", menu_image );
	...
	//jsonitem.menu_name
	$(".modal-meal-name").text(jsonitem.menu_name) ; 
	//$(".modal-meal-sympole").text(jsonitem.currency_symbol) ; 
	$(".modal-meal-price").text(jsonitem.price) ; 

	$(".modal-meal-description").text(jsonitem.description) ; 
