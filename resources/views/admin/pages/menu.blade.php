    ...
    <div class="panel-body">
        ...
        <table id="data-table" class="table table-striped table-hover dt-responsive" cellspacing="0" width="100%">
            ...
            <tr>
                ...
                <a href="{{ url('admin/restaurants/view/'.$restaurant_id.'/menu/delete/'.$item->id) }}" class="btn btn-default btn-rounded" onclick="return confirm('ها تمن متأكد ؟ لن تستطيع إستعادة البانات .')"><i class="md md-delete"></i></a>
            </td>
