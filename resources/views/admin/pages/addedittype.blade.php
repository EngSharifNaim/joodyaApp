...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($type->type) ? 'تحديث: '. $type->type : 'إضافة نوع جديد' }}</h2>
		
		<a href="{{ URL::to('admin/types') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> العودة</a>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">نوع المطبخ</label>
                      <div class="col-sm-9">
                        <input type="text" name="type" value="{{ isset($type->type) ? $type->type : null }}" class="form-control">
                    </div>
                </div> 
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">صورة التصنيف</label>
                    <div class="col-sm-9">
                        <div class="media">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($type->id) ? 'تحديث ' : 'إضافة' }}</button>
