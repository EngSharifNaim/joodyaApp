...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#account" aria-controls="account" role="tab" data-toggle="tab">إعدادات عامة</a>
        </li>
        <li role="presentation">
            <a href="#homepage_settings" aria-controls="homepage_settings" role="tab" data-toggle="tab">إعدادات الصفحة الرئيسية</a>
        </li>
       
        <li role="presentation">
            <a href="#other_Settings" aria-controls="other_Settings" role="tab" data-toggle="tab">إعدادات أخرى</a>
        </li>        
    ...
    <div class="tab-content tab-content-default">
        <div role="tabpanel" class="tab-pane active" id="account">             
            {!! Form::open(array('url' => 'admin/settings','class'=>'form-horizontal padding-15','name'=>'account_form','id'=>'account_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">الشعار</label>
                    <div class="col-sm-9">
                        <div class="media">
                            ...
                            <div class="media-body media-middle">
                                ...
                                <small class="text-muted bold">الحجم 190x23px</small>
                            </div>
                        </div>
				...
				<div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">الأيقونة</label>
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                            ...
                            <div class="media-body media-middle">
                                ...
                                <small class="text-muted bold">الحجم 16x16px</small>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">نص الحقوق اسفل الموقع</label>
                    <div class="col-sm-9">
        ...
        <div role="tabpanel" class="tab-pane" id="homepage_settings">             
            {!! Form::open(array('url' => 'admin/homepage_settings','class'=>'form-horizontal padding-15','name'=>'layout_settings_form','id'=>'layout_settings_form','role'=>'form','enctype' => 'multipart/form-data')) !!}
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">سلايدر 1</label>
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                            ...
                            <div class="media-body media-middle">
                                <input type="file" name="home_slide_image1" class="filestyle">
                                 <small class="text-muted bold">الحجم 1200x450px</small>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">سلايدر 2</label>
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">سلايدر 3</label>
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                ...
                <div class="form-group">
                    <label for="avatar" class="col-sm-3 control-label">خلفية الصورة الرئيسية للموقع</label>
                    <div class="col-sm-9">
                        <div class="media">
                            <div class="media-left">
                            ...
                            <div class="media-body media-middle">
                                <input type="file" name="page_bg_image" class="filestyle">
                                 <small class="text-muted bold">الحجم 1400x350px</small>
                            </div>
                        </div>
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">عدد المطابخ</label>
                    <div class="col-sm-9">
                        <input type="text" name="total_restaurant" value="{{ $settings->total_restaurant }}" class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">عدد المستخدمين المستفيدين من الخدمات</label>
                    <div class="col-sm-9">
                        <input type="text" name="total_people_served" value="{{ $settings->total_people_served }}" class="form-control" value="">
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">عدد المستخدمين المسجلين</label>
                    <div class="col-sm-9">
        ...
        <div role="tabpanel" class="tab-pane" id="other_Settings">
            ...
            {!! Form::open(array('url' => 'admin/headfootupdate','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">كود الهيدر</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="site_header_code" class="form-control" rows="5" placeholder="بإستطاعتك إضافة كود HTML/CSS في الهيدر. ">{{ $settings->site_header_code }}</textarea>
                    </div>
                </div>
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">كود الفوتر</label>
                    <div class="col-sm-9">
                        <textarea type="text" name="site_footer_code" class="form-control" rows="5" placeholder="بإستطاعتك إضافة كود HTML/CSS في الفوتر. ">{{ $settings->site_footer_code }}</textarea>
                    </div>
                </div>
