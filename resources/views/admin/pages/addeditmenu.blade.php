...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($menu->menu_name) ? 'تعديل: '. $menu->menu_name : 'إضافة قائمة جديدة' }}</h2>
		
		<a href="{{ URL::to('admin/restaurants/view/'.$restaurant_id.'/menu') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> العودة</a>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">أصناف القائمة</label>
                    <div class="col-sm-4">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">الأسم</label>
                      <div class="col-sm-9">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($menu->id) ? 'تعديل ' : 'إضافة جديد' }}</button>
