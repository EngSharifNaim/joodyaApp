...
<span aria-hidden="true">&times;</span></button>
    ...
    <ul class="nav nav-tabs" role="tablist">
        <li role="presentation" class="active">
            <a href="#account" aria-controls="account" role="tab" data-toggle="tab">الحساب الشخصي</a>
        </li>
        <li role="presentation">
            <a href="#ac_password" aria-controls="ac_password" role="tab" data-toggle="tab">كلمة المرور</a>
        </li>        
        </li>
    </ul>
    ...
    <div class="tab-content tab-content-default">
                    ...
                    <div class="col-sm-9">
                        <div class="media">
                            ...
                            <div class="media-body media-middle">
                                ...
                                <small class="text-muted bold">الحجم 80x80px</small>
                            </div>
                        </div>
        ...
        <div role="tabpanel" class="tab-pane" id="ac_password">
            ...
            {!! Form::open(array('url' => 'admin/profile_pass','class'=>'form-horizontal padding-15','name'=>'pass_form','id'=>'pass_form','role'=>'form')) !!}
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">تأكيد كلمة المرور</label>
                    <div class="col-sm-9">
