...
<div id="main">
	<div class="page-header">
		<h2> {{ isset($cat->category_name) ? 'تحديث : '. $cat->category_name : 'إضافة' }}</h2>
		
		<a href="{{ URL::to('admin/categories') }}" class="btn btn-default-light btn-xs"><i class="md md-backspace"></i> العودة</a>
   	...
   	<div class="panel panel-default">
            <div class="panel-body">
                ...
                <div class="form-group">
                    <label for="" class="col-sm-3 control-label">التصنيف</label>
                      <div class="col-sm-9">
                ...
                <div class="form-group">
                    <div class="col-md-offset-3 col-sm-9 ">
                    	<button type="submit" class="btn btn-primary">{{ isset($cat->id) ? 'تحديث ' : 'إضافة' }}</button>
